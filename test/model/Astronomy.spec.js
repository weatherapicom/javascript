...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Astronomy', function() {
      beforeEach(function() {
        instance = new WeatherApi.Astronomy();
      });

      it('should create an instance of Astronomy', function() {
        // TODO: update the code to test Astronomy
        expect(instance).to.be.a(WeatherApi.Astronomy);
      });

      it('should have the property astro (base name: "astro")', function() {
        // TODO: update the code to test the property astro
        expect(instance).to.have.property('astro');
        // expect(instance.astro).to.be(expectedValueLiteral);
      });
