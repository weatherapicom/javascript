...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ArrayOfSearch', function() {
      beforeEach(function() {
        instance = new WeatherApi.ArrayOfSearch();
      });

      it('should create an instance of ArrayOfSearch', function() {
        // TODO: update the code to test ArrayOfSearch
        expect(instance).to.be.a(WeatherApi.ArrayOfSearch);
      });
