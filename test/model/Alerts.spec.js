...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Alerts', function() {
      beforeEach(function() {
        instance = new WeatherApi.Alerts();
      });

      it('should create an instance of Alerts', function() {
        // TODO: update the code to test Alerts
        expect(instance).to.be.a(WeatherApi.Alerts);
      });

      it('should have the property alert (base name: "alert")', function() {
        // TODO: update the code to test the property alert
        expect(instance).to.have.property('alert');
        // expect(instance.alert).to.be(expectedValueLiteral);
      });
