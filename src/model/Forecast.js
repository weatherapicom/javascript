...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WeatherApi.Forecast = factory(root.WeatherApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('forecastday'))
        obj.forecastday = ApiClient.convertToType(data['forecastday'], [Object]);
    }
    return obj;
  }

  /**
   * @member {Array.<Object>} forecastday
   */
  exports.prototype.forecastday = undefined;
